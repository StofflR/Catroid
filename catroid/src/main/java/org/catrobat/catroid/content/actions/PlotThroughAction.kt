...
class PlotThroughAction : TemporalAction() {
    ...
    private var ps: Point = Point()
    private var pa: Point = Point()
    private var prevPercent: Double = 0.0
    ...
    override fun update(percent: Float) {
        try {
            val stepsFrom = steps * prevPercent
            val stepsTo = (steps + 1) * percent
            for (i in stepsFrom.toInt()..stepsTo.toInt()) {
